...
CREATE TABLE `patient_has_doctor` (
  ...
  PRIMARY KEY (`patient_p_id`,`doctor_E_id`),
  KEY `fk_patient_has_doctor_doctor1_idx` (`doctor_E_id`),
  KEY `fk_patient_has_doctor_patient1_idx` (`patient_p_id`),
  CONSTRAINT `fk_patient_has_doctor_doctor1` FOREIGN KEY (`doctor_E_id`) REFERENCES `doctor` (`E_id`),
  CONSTRAINT `fk_patient_has_doctor_patient1` FOREIGN KEY (`patient_p_id`) REFERENCES `patient` (`p_id`)
...
-- Dump completed on 2021-02-22  7:23:14
